...
const char* backColor = "red";//CSS da página

const char* tallyCompany = "Smart Media";

const char* tallyDescriptions = "Igreja Mover 2024";
//--------------------------Tally AP CONFIGS----------------------------------

IPAddress tallyIp(192, 168, 48, 15); // Mude para o endereço de IP que desejar para o Web Menu, por exemplo : 192, 168, 48, 15, use esse IP para acessar sua tally web menu http://192.168.48.15

  const char* ssidTally = "vMix_Tally_Light_MOVER_%d";//Essa é a sua SSID. Mude "Smart_Tally_Lights..." para o nome da sua tally, mas não mude/delete o "_%d". 
 
  const char* passwordTally = "vicksmedia";//Essa é a sua senha. Mude "vicksmedia" para uma senha de sua preferência
